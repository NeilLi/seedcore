...
> Reference scope: this earlier guide targets Reachy simulation. Its commands
> and ports must not be treated as Microduck bring-up instructions. Use the
> [Microduck integration plan](microduck_integration_plan.md) for the active track.
