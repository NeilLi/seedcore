...
- `docs/development/robotics/vla_2026_optimizations.md` keeps VLA/robotics work outside
...
- `docs/development/operations/freshness_sla_edge_stress_schedule.md` defines simulator,
