...
- for an implementation-oriented flow that turns retrieved memory into a
  ...
  [Trading Memory Admissibility Flow](../learning/trading_memory_admissibility_flow.md)
...
order, see [local_kafka_streams_schedule.md](../integrations/local_kafka_streams_schedule.md).
