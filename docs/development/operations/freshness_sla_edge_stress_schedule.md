...
[Physical Telemetry Processing Contract](../evidence/physical_telemetry_processing_contract.md).
...
- [SeedCore 2026 Execution Plan](../strategy/seedcore_2026_execution_plan.md)
- [Hardware-Anchored Telemetry MVP Contract](../evidence/hardware_anchored_telemetry_mvp_contract.md)
- [RTX Spark Autonomous Era Investigation](../infrastructure/rtx_spark_autonomous_era_investigation.md)
