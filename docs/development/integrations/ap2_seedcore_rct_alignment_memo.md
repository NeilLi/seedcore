...
1. Keep `../trust-runtime/agent_action_gateway_contract.md` as the current SeedCore external
   contract authority.
2. Keep `../applications/rct/rare_shoes_collecting_transfer_demo_spec.md` explicit that commercial
