...
- `docs/development/learning/legible_local_memory_vault.md`
- `docs/development/learning/memory_module_refactor_spec.md`
...
- `docs/development/strategy/north_star_autonomous_trade_environment.md`
