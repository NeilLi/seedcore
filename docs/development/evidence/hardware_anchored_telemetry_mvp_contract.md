...
- [Agent Action Gateway Contract](../trust-runtime/agent_action_gateway_contract.md)
- [Edge Telemetry Evidence Closure Draft](edge_telemetry_evidence_closure_draft.md)
- [Physical Telemetry Processing Contract](physical_telemetry_processing_contract.md)
- [Virtual NFC Simulation Plan](../applications/rct/virtual_nfc_simulation_plan.md)
- [TPM Fleet Rollout Runbook](../operations/tpm_fleet_rollout_runbook.md)
- [Rare-Shoe RCT Demo Spec](../applications/rct/rare_shoes_collecting_transfer_demo_spec.md)
