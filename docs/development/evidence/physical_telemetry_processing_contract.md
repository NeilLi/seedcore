...
- `../operations/freshness_sla_edge_stress_schedule.md` defines simulator, prototype edge,
  trusted edge, and robotics handoff lanes.
- `../robotics/world_action_model_architecture_reference.md` defines WAM rollout and runtime
