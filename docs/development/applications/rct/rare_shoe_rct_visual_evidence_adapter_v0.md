...
> Stage update (2026-09-17): Maintained as a regression/reference baseline; new application expansion is deferred.
...
- [`../../infrastructure/persistent_counter_ledger_plan.md`](../../infrastructure/persistent_counter_ledger_plan.md)
- [`../../infrastructure/kms_ntag_transition_plan.md`](../../infrastructure/kms_ntag_transition_plan.md)
