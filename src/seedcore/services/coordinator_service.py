        ...
        *,
        ...
        payload = {
            ...
            "break_glass": {
                ...
                "reason_code": break_glass.get("reason_code"),
                ...
                "procedure_id": break_glass.get("procedure_id"),
                "incident_id": break_glass.get("incident_id"),
                "risk_score": break_glass.get("risk_score"),
                "ocps_score": break_glass.get("ocps_score"),
        ...
        if authz_graph:
            payload["authz_graph"] = {
                ...
                "snapshot_ref": authz_graph.get("snapshot_ref"),
                "snapshot_id": authz_graph.get("snapshot_id"),
                "snapshot_version": authz_graph.get("snapshot_version"),
        ...
        if governed_receipt:
            payload["governed_receipt"] = {
                ...
                "snapshot_ref": governed_receipt.get("snapshot_ref"),
                "snapshot_id": governed_receipt.get("snapshot_id"),
                "snapshot_version": governed_receipt.get("snapshot_version"),
                "snapshot_hash": governed_receipt.get("snapshot_hash"),
